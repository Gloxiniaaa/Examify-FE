...
import { fetchUserInfo, selectUser, updateUserInfo, changePassword } from "../store/userSlice";
...
const UserProfile = () => {
  ...
  const handleUpdateSubmit = async (e) => {
    e.preventDefault();
    const result = await dispatch(updateUserInfo({ userId, updateData: updateForm }));
    if (!result.error) {
  ...
  const handlePasswordChange = async (e) => {
    ...
    if (!passwordForm.oldPassword || !passwordForm.newPassword || !passwordForm.username) {
  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-16">
        {!userInfo ? (
          <p className="text-neutral-600 text-center">No user information available.</p>
        ) : (
          <>
            <section className="mb-12">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-3xl font-bold text-neutral-800">User Profile</h2>
                <button
            ...
            <section className="mb-12">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold text-neutral-800">Change Password</h3>
                <button
